...
{title:e,link:c,short_link:c,shortener:SHRTB_Settings.shortener?SHRTB_Settings.shortener:"google",shortener_key:SHRTB_Settings.shortener_key?SHRTB_Settings.shortener_key:"",v:1,apitype:1,apikey:SHR4P.TB.shr_apiKey,twitter_template:SHR4P.TB.shr_twitter_template?SHR4P.TB.shr_twitter_template:"${title} - ${short_link}",service:7};[SHR4P.TB.shr_link,a.param(n)].join("?");a(this).before(a('<style type="text/css"> div.shareaholic a{background-image:url('+(SHR4P.TB.shr_image||SHR4P.TB.shr_twitter_image)+
