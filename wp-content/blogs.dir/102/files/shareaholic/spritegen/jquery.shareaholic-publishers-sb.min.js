...
SHR4P.fbUtil.addLikeButton(j,b.link);d.prepend(j);b.fbButtonPos.indexOf("bottom")!=-1?d.insertAfter(this):d.insertBefore(this);b.fbButtonPos.indexOf("right")!=-1&&j.css("float","right")}a(b.service.split(",")).each(function(d,c){var f="";if(c=="7")f=b.twitter_template;b.custom_link["before_"+d]&&h("before",d,b).appendTo(i);var g=b.designer_toolTips?"orig_title":"title",k=SHR4P.utils.getBrowserLocale(),k=k.split("-")[0];if(typeof SHR4P.locales!=="undefined"&&(typeof SHR4P.locales[k]=="undefined"||
!SHR4P.locales[k]))k="en";k=typeof SHR4P.locales!=="undefined"?SHR4P.locales[k][SHR4P.tooltips_prefix_map[c]]+" "+SHR4P.tooltips_suffix[c]:"";c=="7"&&b.twitter_overlay&&!SHR4P.utils.isMobileBrowser()?a("<li/>").addClass("shr-"+c).addClass("shareaholic").append(a("<a/>").attr({rel:b.rel,target:b.target,"class":"external"}).attr(g,k).text(k).click(function(a){SHR4P.utils.showServiceLet(b,"twitter");a.preventDefault()})).attr("style","margin-left:"+b.li_margin+"px !important;").appendTo(i):a("<li/>").addClass("shr-"+
c).addClass("shareaholic").append(a("<a/>").attr({href:e(b.share_src+b.api.share.url,{title:b.title,link:b.link,notes:b.notes,short_link:b.short_link,shortener:b.shortener,shortener_key:b.shortener_key,v:b.api.share.v,apitype:b.api.share.apitype,apikey:b.apikey,source:b.api.share.source,template:f,service:c,ctype:b.ctype}),rel:b.rel,target:b.target,"class":"external"}).attr(g,k).text(k)).attr("style","margin-left:"+b.li_margin+"px !important;").appendTo(i);if(!b.dontShowShareCount&&(c==5||c==7||c==
2||c==257))f=function(b){b=b.count;if(b>0||b!="0"&&b!=0){for(var d=a("<div/>").addClass("shr-count").appendTo(i.find(".shr-"+c)),e=0;e<9;e+=1)e!=4&&d.append(a("<div>"+b+"</div>").addClass("shr-count-outline").css({left:10+e%3-1+"px",top:"-"+(11+parseInt(e/3)-1)+"px"}).attr("aria-hidden","true"));d.append(a("<div>"+b+"</div>").addClass("shr-count-center").css({left:"10px",top:"-11px"}).attr("aria-label","Number of times this webpage has been shared"))}},c==5?SHR4P.utils.getFbShrCnt(b.link,f):c==7?
SHR4P.utils.getTwitShrCnt(b.link,f):c==2?SHR4P.utils.getDeliciousShrCnt(b.link,f):c==257&&SHR4P.utils.getGoogBuzzShrCnt(b.link,f);b.custom_link["after_"+d]&&h("after",d,b).appendTo(i)});var l=function(){var b=a("<div style='position:absolute !important; background: transparent !important; z-index:101 !important;'/>"),d=a("<div class = 'shareaholic-tip-text'></div>"),c=a("<div class = 'shareaholic-arrow-down'/>");b.append(d);b.append(c);return{show:function(c){if(!a("body").find(".shareaholic-tip-text").length){var e=
