...
!1;break;case "none":l=g=!1}g&&(k+="-count",j+="-count");g&&l&&(k+="-compact",j+="-compact");if(g){var i=this;if(l)this.style.marginRight="0px",d=document.createElement("div"),i=document.createElement("div"),f=this.parentNode,f.appendChild(i),i.className="shr_compact_div",d.className="shr_compact_tick",d.appendChild(document.createElement("s")),d.appendChild(document.createElement("i")),f.insertBefore(d,i);g&&SHR4P.TB.utils.getTwitShrCnt(c,function(a){i.innerHTML=a.count})}var n={title:e,link:c,short_link:c,
